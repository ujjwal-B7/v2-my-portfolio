  ...
  return (
    <>
      <section className="relative h-[calc(100vh-5rem)] flex justify-center items-center">
        <div className="xl:w-[60%] md:w-[80%] xl:ml-0 sm:ml-10 sm:px-0 px-4 ">
          <h2 className="text-[1.2rem] highlighted-text">Hi, my name is</h2>
          <h1 className="pt-5 big-heading font-[600] title">Ujjwal Basnet.</h1>
          <h3 className="big-heading secondary-text text-7xl font-[600]">
            I build things for the web.
          </h3>
          <p className="sm:w-[70%] mt-5 mb-9">
        ...
        {/* social media links */}
        <div className="md:block hidden fixed bottom-0 lg:left-14 left-10 space-y-6 social-media-icons">
          <div className="icons">
